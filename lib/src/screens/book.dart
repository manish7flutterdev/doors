                     ...
                     child: Container(
                       child: SingleChildScrollView(
                         child: Column(
                           children: [
                             SizedBox(height: 30,),
                   Text(_mainController.data[widget.index]['title'].toString(),
                          textAlign: TextAlign.center,
                          style: Fonts.tangerineBold(90, Colors.white),),
                   SizedBox(height: 10,),
                             Obx(()=>Container(
                               width: width/1.05,
                               child: Text("  "+
                                 _mainController.data[widget.index]['content'].toString() + "                                            ",
                                 textAlign: TextAlign.center,
                                 
                               style: Fonts.tangerine(39, Colors.white),
                               ),
                             ))
                           ],
                         ),
