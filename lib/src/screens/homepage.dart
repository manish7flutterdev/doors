          ...
          child: Column(
            children: [
             ...
             Text("Parts of me".toString(),
                    ...
                    style: Fonts.puppies(100, Colors.white),),
             ListView.builder(
               shrinkWrap: true,
               ...
               return Padding(
                 ...
                 child: ListTile(
                   ...
                   title: Text(_mainController.data[index]['title'].toString(),style: Fonts.akebono(22, Colors.white),),
                   subtitle: Text(_mainController.data[index]['subtitle'].toString(),style: Fonts.akebono(13, Colors.white.withOpacity(0.5)),),
                   leading: CircleAvatar(
                           radius: 40,
                           backgroundImage: NetworkImage(_mainController.data[index]['image'].toString()), // no matter how big it is, it won't overflow
                        ),
